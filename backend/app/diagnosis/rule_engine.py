...
RULES: list[tuple[str, RuleResult]] = [
    ...
    ("keyerror", RuleResult("Missing dictionary key",
        "Code indexed a dict key that does not exist; use dict.get() with a default.", 0.8,
        "restart_service", "low", "critical")),
    ("modulenotfounderror", RuleResult("Missing Python dependency",
        "Required module is not installed.", 0.9, "install_dependency", "low", "warning")),    ("cannot find module", RuleResult("Missing JS dependency",
