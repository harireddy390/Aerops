...
TRANSITIONS = {
    ...
    "INVESTIGATING": {"DIAGNOSED", "FAILED", "OPEN", "ESCALATED_MANUAL"},
    "DIAGNOSED": {"REMEDIATING", "RECOVERING", "FAILED", "OPEN", "ESCALATED_MANUAL"},
    "REMEDIATING": {"RECOVERING", "FAILED", "OPEN", "ESCALATED_MANUAL"},
    "RECOVERING": {"RESOLVED", "FAILED"},
    "ACKNOWLEDGED": {"INVESTIGATING", "RESOLVED", "FAILED"},
    "FAILED": {"INVESTIGATING"},
    "ESCALATED_MANUAL": {"INVESTIGATING", "RESOLVED"},
    "RESOLVED": set(),
}
